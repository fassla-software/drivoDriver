              ...
              ? SingleChildScrollView(
                  child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                ...
                                SummeryItem(
                                  title: PriceConverter.convertDistance(
                                      double.tryParse(rideController
                                          .tripDetail!.actualDistance
                                          .toString())),
                                ...
                                children: [
                                  ...
                                  if (rideController.tripDetail?.type !=
                                    ...
                                    PaymentItemInfoWidget(
                                      ...
                                      title: 'idle_price'.tr,
                                      amount:
                                          rideController.tripDetail!.idleFee ??
                                              0,
                                    ),
                                  if (rideController.tripDetail?.type !=
                                      'parcel')
                                    PaymentItemInfoWidget(
                                      ...
                                      amount:
                                          rideController.tripDetail!.delayFee ??
                                              0,
                                    ),
                                  if (rideController.tripDetail?.type !=
                                      'parcel')
                                  ...
                                  PaymentItemInfoWidget(
                                    ...
                                    title: 'tips'.tr,
                                    amount:
                                        rideController.tripDetail!.tips ?? 0,
                                  ),
                                  PaymentItemInfoWidget(
                                    icon: Images.farePrice,
                                    title: 'vat_tax'.tr,
                                  ...
                                  if (rideController.tripDetail?.type ==
                                    ...
                                    PaymentItemInfoWidget(
                                      icon: Images.farePrice,
                                      title: 'paid'.tr,
                                      amount: double.parse(rideController
                                              .tripDetail!.paidFare!) -
                                          (rideController
                                                  .tripDetail?.dueAmount ??
                                              0),
                                    ),
                                    PaymentItemInfoWidget(
                                      icon: Images.farePrice,
                        ...
                        if (rideController.tripDetail?.currentStatus ==
                                'returning' &&
                        ...
                        if (rideController.tripDetail?.parcelRefund !=
                          ...
                          Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  if (rideController
                                          .tripDetail?.parcelRefund?.status ==
                                  ...
                                  if (rideController
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        rideController.tripDetail?.parcelRefund
                                                    ?.status ==
                                  ...
                                  if (rideController.tripDetail?.parcelRefund
                                    ...
                                    CustomerNoteViewWidget(
                                      ...
                                      details: rideController.tripDetail
                                              ?.parcelRefund?.customerNote ??
                                          '',
                                  ...
                                  GridView.builder(
                                      shrinkWrap: true,
                                      itemCount: rideController.tripDetail
                                          ?.parcelRefund?.attachments?.length,
