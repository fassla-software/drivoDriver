                        ...
                        Padding(
                          ...
                          child: Row(children: [
                            Padding(
                              ...
                              child:
                                  Image.asset(Images.calenderIcon, scale: 2.5),
                            ),
                            Text(
                              DateConverter.localToIsoString(DateTime.parse(
                                  review.createdAt ??
                          ...
                          child: (review.isLoading ?? false)
                              ...
                              : Padding(
                                  padding: const EdgeInsets.only(
                                      left: Dimensions.paddingSizeSmall),
                                  child: Icon(
                                    (review.isSaved ?? false)
                                        ? Icons.bookmark
                                        : Icons.bookmark_border,
                                    color: (review.isSaved ?? false)
                                        ? Theme.of(context).primaryColor
                                        : Get.isDarkMode
                                            ? Theme.of(context)
                                                .hintColor
